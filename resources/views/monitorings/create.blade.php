...
@section('content')
                ...
                <div class="card">
                    <div class="card-body p-2">
                        <div class="col">
                            ...
                            <form class="col mt-3" method="POST" action="{{ route('monitorings.store') }}">
                                @csrf
                                <div class="mb-3">
                                    <input type="text" class="form-control @error('city') is-invalid @enderror"
                                        name="city" id="city"
                                        value="{{ isset(auth()->user()->city->name) ? old('city', auth()->user()->city->name) : '' }}"
                                ...
                                <div class="mb-3">
                                    <input type="text" class="form-control @error('street') is-invalid @enderror"
                                        name="street" value="{{ $street ?? old('street') }}" id="street"
                                ...
                                <div class="mb-3">
                                    <input type="text"
                                        ...
                                        value="{{ $house_number ?? old('house_number') }}" name="house_number"
                                        ...
                                        <div class="card-body p-1" id="container">
                                            ...
                                            @for ($i = 1; $i <= old('countEntrances', $countEntrances); $i++)
                                                <div class="d-flex justify-content-between flex-row align-center mb-2">
                                                    ...
                                                    <div class="mb-1 form-check d-flex justify-content-center align-items-center"
                                                        style="width: 55px;">
                                                        <input type="checkbox" class="form-check-input" name="competitors[]"
                                                            id="competitor{{ $i }}" value="{{ $i }}"
                                            ...
                                            <input type="hidden" name="latitude" id="latitude" value="{{ $latitude ?? old('latitude') }}">
                                            <input type="hidden" name="longitude" id="longitude" value="{{ $longitude ?? old('longitude') }}">
                                            <input type="hidden" name="order_id" id="order_id" value="{{ $order_id ?? old('order_id') }}">
                                            <button type="button" id="add_entrance" onclick="addFields()"
                                                class="btn btn-secondary w-100">+
                                                {{ __('monitorings.create.form.add_entrance') }}
                                            </button>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        ...
        // форматирование города для отображения без "г"
        ...
        <div class="mb-1" style="width: 60px;">
            <input type="number" class="form-control p-1" name="floors[]" placeholder="0" value="0">
        </div>
        <div class="mb-1" style="width: 60px;">
            <input type="number" class="form-control p-1" name="stickers[]" placeholder="0" value="0">
        </div>
        <div class="mb-1 form-check d-flex justify-content-center align-items-center" style="width: 55px;">
